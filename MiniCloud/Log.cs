...
namespace MiniCloud
{
    static class Log
    {
        ...
        public static Popper Push(object value)
        {
            ...
            CallContext.LogicalSetData("log", newCtx);
            return new Popper();
        }
        ...
        public static LogContext Pop()
        {
            ...
            CallContext.LogicalSetData("log", LogContext.Current.Next);
            return newCtx;
        }
    ...
    class LogContext : IEnumerable<LogContext>
    {
        ...
        public static LogContext Current => (LogContext)CallContext.LogicalGetData("log") ?? Empty;
